...
Public Class CrearEnInventarioDebe
    ...
    <Fact> Public Sub DevolverClienteCreado_CuandoSeCreaUno()
        Dim sut = CreateSystemUnderTest()
        Dim producto = sut.Crear(Constantes.LATA_DE_ARVEJAS, Constantes.PRECIO_UNITARIO_LATA_DE_ARVEJAS, Constantes.CODIGO_DE_LATA_DE_ARVEJAS)
    ...
    <Fact> Public Sub CrearProductoConCodigoIgualAUnoExistente_CuandoSeCreaUnoRepetido()
        Dim sut = CreateSystemUnderTest()
        Dim producto = sut.Crear(Constantes.LATA_DE_ARVEJAS, Constantes.PRECIO_UNITARIO_LATA_DE_ARVEJAS, Constantes.CODIGO_DE_LATA_DE_ARVEJAS)
        Dim otroProducto = sut.Crear(Constantes.LATA_DE_CERVEZA, Constantes.PRECIO_UNITARIO_LATA_DE_CERVEZA, Constantes.CODIGO_DE_LATA_DE_ARVEJAS)
    ...
    <Fact> Public Sub LanzarExcepcion_CuandoSeIntentaCrearProductoConCodigoYaAgregado()
        ...
        Dim exception = Assert.Throws(GetType(ArgumentException), Sub() sut.Crear(Constantes.LATA_DE_CERVEZA, Constantes.PRECIO_UNITARIO_LATA_DE_CERVEZA, Constantes.CODIGO_DE_LATA_DE_ARVEJAS))
    ...
    <Fact> Public Sub LanzarExcepcion_CuandoSeIntentaCrearProductoConPrecioNegativo()
        ...
        Dim exception = Assert.Throws(GetType(ArgumentException), Sub() sut.Crear(Constantes.LATA_DE_ARVEJAS, -1, Constantes.CODIGO_DE_LATA_DE_ARVEJAS))
    ...
    Public Sub LanzarExcepcion_CuandoSeIntentaCrearProductoConCodigoInvalido(codigoInvalido As String)
        ...
        Dim exception = Assert.Throws(GetType(ArgumentException), Sub() sut.Crear(Constantes.LATA_DE_ARVEJAS, Constantes.PRECIO_UNITARIO_LATA_DE_ARVEJAS, codigoInvalido))
