...
/*
            for (var m = 1; m <= 9; m++)
            {
            for (var htho = 1; htho <= 9; htho++)
            {
                for (var ttho = 1; ttho <= 9; ttho++)
                {
                    for (var tho = 1; tho <= 9; tho++)
                    {
                        for (var hun = 1; hun <= 9; hun++)
                        {
                            for (var ten = 1; ten <= 9; ten++)
                            {
                                for (var one = 1; one <= 9; one++)
                                {
                                    sut = new ArithmeticLogicUnit(EIGHT_LOOP_INSTRUCTIONS);
                                    sut.Input(2);
                                    sut.Input(m);
                                    sut.Input(htho);
                                    sut.Input(ttho);
                                    ...
                                    if (sut.Z == 0)
                                    {
                                        Console.WriteLine($"2{m}{htho}{ttho}{tho}{hun}{ten}{one} is {sut.Z}");
                                    }
                                }
                            }
                       }
