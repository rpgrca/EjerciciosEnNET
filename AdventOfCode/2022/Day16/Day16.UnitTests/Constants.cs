...
{
    public const string SAMPLE_INPUT = @"Valve AA has flow rate=0; tunnels lead to valves DD, II, BB
...
Valve JJ has flow rate=21; tunnel leads to valve II";
    ...
    public const string PUZZLE_INPUT = @"Valve BT has flow rate=0; tunnels lead to valves EZ, TO
