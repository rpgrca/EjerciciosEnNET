...
namespace AdventOfCode2020.Day4.UnitTests
{
    ...
    {
        [Fact]
        public void ReturnTrue_WhenPassportDataIsValid()
        {
            const string data = @"ecl:gry pid:860033327 eyr:2020 hcl:#fffffd
byr:1937 iyr:2017 cid:147 hgt:183cm";
            var sut = new Passport(data);
...
iyr:2011 ecl:brn hgt:59in")]
        [InlineData(@"pid:860033327 eyr:2020 hcl:#fffffd
byr:1937 iyr:2017 cid:147 hgt:183cm")]
        [InlineData(@"ecl:gry eyr:2020 hcl:#fffffd
byr:1937 iyr:2017 cid:147 hgt:183cm")]
        [InlineData(@"ecl:gry pid:860033327 hcl:#fffffd
byr:1937 iyr:2017 cid:147 hgt:183cm")]
        [InlineData(@"ecl:gry pid:860033327 eyr:2020
byr:1937 iyr:2017 cid:147 hgt:183cm")]
        [InlineData(@"ecl:gry pid:860033327 eyr:2020 hcl:#fffffd
byr:1937 cid:147 hgt:183cm")]
        [InlineData(@"ecl:gry pid:860033327 eyr:2020 hcl:#fffffd
byr:1937 iyr:2017 cid:147")]
        public void ReturnFalse_WhenPassportIsMissingRequiredField(string dataMissingRequiredField)
        {
            var sut = new Passport(dataMissingRequiredField);
            Assert.False(sut.IsValid());
        }

        [Fact]
        public void ReturnTrue_WhenPassportFromNorthPoleIsChecked()
        {
            const string data = @"hcl:#ae17e1 iyr:2013
eyr:2024
...
hgt:179cm";
        ...
        [Fact]
        public void ReturnFalse_WhenMissingDataExistsAsValueForOtherField()
        {
            const string data = @"ecl:hgt pid:860033327 eyr:2020 hcl:#fffffd
byr:1937 iyr:2017 cid:147";
            var sut = new Passport(data);
            Assert.False(sut.IsValid());
        }
...
ecl:oth hcl:#602927 eyr:2025 iyr:2013 hgt:151cm byr:1992 pid:812583062";
            ...
            Assert.Equal(235, validPassports);
        }
...
byr:1937 iyr:2021 cid:147 hgt:183cm")]
        [InlineData(@"ecl:gry pid:860033327 eyr:2019 hcl:#fffffd
byr:1937 iyr:2017 cid:147 hgt:183cm")]
        [InlineData(@"ecl:gry pid:860033327 eyr:2031 hcl:#fffffd
byr:1937 iyr:2017 cid:147 hgt:183cm")]
        [InlineData(@"ecl:gry pid:860033327 eyr:2020 hcl:#fffffd
...
byr:1937 iyr:2017 cid:147 hgt:77in")]
        [InlineData(@"ecl:gry pid:860033327 eyr:2020 hcl:#fffff
byr:1937 iyr:2017 cid:147 hgt:183cm")]
        [InlineData(@"ecl:gry pid:860033327 eyr:2020 hcl:ffffff
byr:1937 iyr:2017 cid:147 hgt:183cm")]
        [InlineData(@"ecl:gry pid:860033327 eyr:2020 hcl:fffffff
byr:1937 iyr:2017 cid:147 hgt:183cm")]
        [InlineData(@"ecl:gry pid:860033327 eyr:2020 hcl:#fffffff
byr:1937 iyr:2017 cid:147 hgt:183cm")]
        [InlineData(@"ecl:gry pid:860033327 eyr:2020 hcl:#fffffg
byr:1937 iyr:2017 cid:147 hgt:183cm")]
        [InlineData(@"ecl:amv pid:860033327 eyr:2020 hcl:#fffffd
byr:1937 iyr:2017 cid:147 hgt:183cm")]
        [InlineData(@"ecl:gry pid:0033327 eyr:2020 hcl:#fffffd
byr:1937 iyr:2017 cid:147 hgt:183cm")]
        [InlineData(@"ecl:gry pid:8600333271 eyr:2020 hcl:#fffffd
byr:1937 iyr:2017 cid:147 hgt:183cm")]
        [InlineData(@"ecl:gry pid:86003A271 eyr:2020 hcl:#fffffd
byr:1937 iyr:2017 cid:147 hgt:183cm")]
        public void ReturnFalse_IfValidatingStrictly(string invalidData)
        {
            var sut = new Passport(invalidData);
            Assert.False(sut.IsStrictlyValid());
        }
...
eyr:2022")]
        ...
        public void ReturnTrue_WhenStrictlyValidatingCorrectData(string validData)
        {
            var sut = new Passport(validData);
            Assert.True(sut.IsStrictlyValid());
        }
...
ecl:oth hcl:#602927 eyr:2025 iyr:2013 hgt:151cm byr:1992 pid:812583062";
            ...
            var validPassports = 0;
            foreach (var passport in data.Split("\r\n\r\n"))
            {
                if (new Passport(passport).IsStrictlyValid())
                {
                    validPassports++;
                }
            }

            Assert.Equal(194, validPassports);
        }
    }
}