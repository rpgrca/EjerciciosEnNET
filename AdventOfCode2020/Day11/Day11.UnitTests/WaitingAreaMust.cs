...
#.#L#L#.##")]
        ...
        public void Test1(string layout, string expectedLayout)
        {
...
#.#L#L#.##";
        ...
        {
            var data = @"LLLLL.LLL.LLLLLLLLLLLLLLL.LLLLLLLLL.LLLLLLLLLLLLL.LLLLLLL.LLLLLLL.LLLLL.LLLLLLLLLLLLLLLLLLL.LLLLL
...
LLLLLLLLLLLLLLLL.LLLLLLL..LLLLLLLLLLLLLLL.LLLLLLLLLLLLLLLL.LLLL.L..LLLL.L.LLLLL..LLLL.LLLLL.LLLLL";
            var sut = new WaitingArea(data);

            var previousData = "";
            do
            {
                previousData = sut.Layout;
                sut.AddPassengers();
            }
            while (sut.Layout != previousData);

            Assert.Equal(2334, sut.Layout.Count(p => p == '#'));
        }
...
...#.....";
            ...
            var sut = new WaitingArea(layout);
            Assert.Equal(8, sut.CountSurroundingPlacesAtLongDistance(4, 3, '#'));
        }
...
.............";
            ...
            var sut = new WaitingArea(layout);
            Assert.Equal(0, sut.CountSurroundingPlacesAtLongDistance(1, 1, '#'));
        }
...
.##.##.";
            ...
            var sut = new WaitingArea(layout);
            Assert.Equal(0, sut.CountSurroundingPlacesAtLongDistance(3,3, '#'));
        }

        [Fact]
        public void Test12()
        {
            const string layout = @"L.LL.LL.LL
LLLLLLL.LL
L.L.L..L..
LLLL.LL.LL
L.LL.LL.LL
...
L.LLLLL.LL";
            ...
            var sut = new WaitingArea(layout);
            sut.AddPassengersWithLongDistanceRange();
...
LLLLLLLLLLLLLLLL.LLLLLLL..LLLLLLLLLLLLLLL.LLLLLLLLLLLLLLLL.LLLL.L..LLLL.L.LLLLL..LLLL.LLLLL.LLLLL";
            ...
            Assert.Equal(2100, sut.Layout.Count(p => p == '#'));
        }
    }
}